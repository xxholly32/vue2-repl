...
export class ReplStore implements Store {
  ...
  private defaultvueEsmUrl: string
  private pendingCompiler: Promise<any> | null = null

  constructor({
    serializedState = '',
    defaultvueEsmUrl = `https://unpkg.com/vue/dist/vue.esm.js`,
    showOutput = false,
    outputMode = 'preview'
  }: StoreOptions = {}) {
    ...
    this.defaultvueEsmUrl = defaultvueEsmUrl
    ...
    this.state = reactive({
      ...
      errors: [],
      vueEsmUrl: this.defaultvueEsmUrl
    })
  ...
  private initImportMap() {
    ...
    if (!map) {
      ...
      try {
        ...
        if (!json.imports.vue) {
          json.imports.vue = this.defaultvueEsmUrl
  ...
  resetVueVersion() {
    ...
    this.state.vueEsmUrl = this.defaultvueEsmUrl
    const importMap = this.getImportMap()
    const imports = importMap.imports || (importMap.imports = {})
    imports.vue = this.defaultvueEsmUrl
    this.setImportMap(importMap)
