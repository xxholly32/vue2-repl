...
export async function compileFile(
  ...
  const { data } = await defaultCompiler(code, filename)
  compiled.js = data.script
  compiled.css = data.style
  compiled.template = data.template
}

export async function compileFileTest(
  store: Store,
  { filename, code, compiled }: File
) {
